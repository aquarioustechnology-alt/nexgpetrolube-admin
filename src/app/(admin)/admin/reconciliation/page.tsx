          ...
          <div className="space-y-4">
              ...
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  ...
                  <p className="text-sm text-muted-foreground">
                    Provider: Razorpay • Event: payment.captured • Attempts: 3/5
            ...
            <div className="rounded-lg border p-4">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <h3 className="font-semibold">
                    KYC Provider Webhook Failure
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    Provider: Karvy • Event: kyc.verified • Attempts: 2/5 • Last
          ...
          <div className="space-y-4">
            <div className="rounded-lg border p-4">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <h3 className="font-semibold">
                    January 15, 2024 - Ledger Reconciliation
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    Total Transactions: 1,247 • Platform Revenue: ₹45,230 •
                    Commission Collected: ₹12,450
                  </p>
                  <div className="mt-2 flex gap-2">
            ...
            <div className="rounded-lg border p-4">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <h3 className="font-semibold">
                    January 14, 2024 - Ledger Reconciliation
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    Total Transactions: 1,189 • Platform Revenue: ₹42,150 •
                    Commission Collected: ₹11,890
                  </p>
                  <div className="mt-2 flex gap-2">
                    <Badge variant="default">Reconciled</Badge>
                    <Badge variant="outline">Balance: ₹0.00</Badge>
            ...
            <div className="rounded-lg border p-4">
              <div className="flex items-center justify-between">
                <div className="space-y-1">
                  <h3 className="font-semibold">
                    January 13, 2024 - Ledger Reconciliation
                  </h3>
                  <p className="text-sm text-muted-foreground">
                    Total Transactions: 1,156 • Platform Revenue: ₹41,230 •
                    Commission Collected: ₹11,450
                  </p>
                  <div className="mt-2 flex gap-2">
