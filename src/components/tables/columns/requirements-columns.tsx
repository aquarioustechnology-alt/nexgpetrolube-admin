...
export const requirementsColumns: ColumnDef<RequirementRow>[] = [
  {
    ...
    cell: ({ row }) => (
      <div>
        ...
        <p className="text-muted-foreground text-xs">Buyer: {row.original.buyer}</p>
      </div>
    ),
  },
  {
    ...
    header: "Quantity",
    cell: ({ getValue }) => (
      <span className="font-medium nums">{getValue<string>()}</span>
    ),
  },
  {
    accessorKey: "urgency",
  ...
  },
  {
    ...
    header: "Posted",
    cell: ({ getValue }) => <span className="nums">{new Date(getValue<string>()).toLocaleDateString()}</span>,
  },
  {
    id: "actions",
    header: "",
      ...
      <div className="flex items-center gap-1">
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end">
            ...
            <DropdownMenuItem className="text-red-600">Close Requirement</DropdownMenuItem>
          </DropdownMenuContent>
        </DropdownMenu>
      </div>
    ),
