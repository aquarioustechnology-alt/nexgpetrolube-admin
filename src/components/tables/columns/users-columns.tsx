...
export const usersColumns: ColumnDef<UserRow>[] = [
  {
    ...
    cell: ({ row }) => (
      <div>
        ...
        <p className="text-muted-foreground">{row.original.email} · {row.original.phone}</p>
      </div>
    ),
  },
  {
    ...
    cell: ({ row }) => (
      <DropdownMenu>
        ...
        <DropdownMenuContent align="end">
          ...
          <DropdownMenuItem onClick={() => console.log("Disable", row.original.id)}>Disable</DropdownMenuItem>
        </DropdownMenuContent>
      </DropdownMenu>
    ),
  },
